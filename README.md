...
```meryl k=18k count PI_G_CH_272_DKDL220008012-1A_HHL2KCCX2_L4_1.fq.gz output $genome.meryl``` Calluphora hilli
```meryl k=18k count PI_G_CQ_50_DKDL220008012-1A_HHL2KCCX2_L4_1.fq.gz output $genome.meryl``` Calliphora quadrimaculata
```meryl k=18k count PI_G_CS_239_DKDL220008012-1A_HHL2KCCX2_L4_1.fq.gz output $genome.meryl``` Calliphora stygia
```meryl k=18k count PI_G_CV_198_DKDL220008012-1A_HHL2KCCX2_L4_1.fq.gz output $genome.meryl``` Calliphora vicina
